...
/**
 * https://developer.android.google.cn/jetpack/compose/testing?hl=ko#custom-semantics-properties
...
fun RallyApp() {
    RallyTheme {
        ...
        Scaffold(modifier = Modifier.semantics { currentScreenProperty = currentScreen },
            topBar = {
                RallyTopAppBar(
